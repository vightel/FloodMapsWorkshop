    ...
    while _hr < 24:
        ...
        while _min < 60:
            ...
            if _hr > 21:
                ...
                downloadFileNames.append( _createLSTFile(_thhr))
                metFile =  _createLSTFile(_thhr) + ".met"
...
while downloadIsNotComplete:
    try:
        ...
        ftp.cwd("/allData/1/MYD11_L2/"+_year+ "/" + _yrDay)
		
        lclDir = os.path.join(BASE_DIR,_year,_yrDay, "lst")
        ...
        print "Completed downloading " + str(k) + " files", downloadIsNotComplete
